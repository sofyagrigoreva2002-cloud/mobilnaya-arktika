...
const systemContent = {
  living: { number: "01", title: "Жильё и быт", copy: "Жилой модуль на 8 спальных мест с общей комнатой и санитарно-бытовой модуль с душевыми, санузлом и прачечной. Внутри поддерживается +20…22 °C." },
  work: { number: "02", title: "Кухня, склад и мастерская", copy: "Кухня-столовая со складом продовольствия и ремонтно-технический модуль: мастерская со сварочным постом, компрессором и складом запчастей для техники." },
  energy: { number: "03", title: "Энергия и связь", copy: "Энергоцентр с основным дизель-генератором 50 кВт и резервным на 20 кВт с автоматическим пуском. Связной модуль: спутниковая и КВ-связь, метеостанция, сервер и видеонаблюдение." },
  transport: { number: "04", title: "Вездеходы BV206 «Лось»", copy: "5–6 машин на одной платформе: грузопассажирские, грузовая платформа, топливовоз, мобильная заправочная станция и машина со сменным спасательным, научным или геологоразведочным оснащением." }
};
